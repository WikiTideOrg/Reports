			...
			<div class="container text-muted py-lg-4">
				<ul class="list-inline">
					<li class="list-inline-item me-4"><a class="link-secondary"
					                                     href="https://meta.wikitide.org/wiki/Privacy_Policy">{{ __('footer-privacy') }}</a></li>
					<li class="list-inline-item me-4"><a class="link-secondary"
					                                     href="https://meta.wikitide.org/wiki/Terms_of_Use">{{ __('footer-tou') }}</a></li>
					<li class="list-inline-item"><a class="link-secondary"
					                                href="https://meta.wikitide.org/wiki/WikiTide_Meta">{{ __('footer-meta') }}</a>
					</li>
				</ul>
